...
def show():
    ...
    if analysis_scope in ["Whole Lifespan", "Both"]:
        ...
        if sharing_metric in ["Percentage", "Both"]:
            ...
            matrix_percent, _ = compute_percent_overlap_matrix(data)
    ...
    if analysis_scope in ["Age-Specific", "Both"]:
        ...
        if sharing_metric in ["Absolute Count", "Both"]:
            ...
            matrix_age_common, _ = compute_common_genes_matrix(data, idx=selected_idx)
        ...
        if sharing_metric in ["Percentage", "Both"]:
            ...
            matrix_age_percent, _ = compute_percent_overlap_matrix(data, idx=selected_idx)

...
# Sidebar navigation - SISTEMA DOPPIO: ANALISI + GENERATORE
st.sidebar.markdown("""
...
# Analysis pages - Lista delle pagine di analisi
analysis_pages = [
...
# NUOVA SEZIONE GENERATOR - SEPARATA
st.sidebar.markdown("""
...
if st.session_state.current_page == "stamp_generator":
    ...
    # Pulisci il nome per il display
